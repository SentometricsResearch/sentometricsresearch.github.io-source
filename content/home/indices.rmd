...
EPU_flanders$value[lubridate::wday(EPU_flanders$timestamp) == 1] = NA
EPU_flanders$MA = NA
EPU_flanders$ind = NA
EPU_flanders$MA[-1:-29] = RcppRoll::roll_mean(EPU_flanders$value, 30,na.rm = TRUE)
EPU_flanders$ind[-1:-29] = RcppRoll::roll_sum(!is.na(EPU_flanders$value), 30,na.rm = TRUE)
EPU_flanders$value = EPU_flanders$MA
EPU_flanders = EPU_flanders[-1:-29,]
EPU_flanders$value[lubridate::wday(EPU_flanders$timestamp) == 1] = NA
EPU_flanders$value[EPU_flanders$ind < 20] = NA
EPU_flanders = EPU_flanders[-1,]
...
EPU_belgium$value[lubridate::wday(EPU_belgium$timestamp) == 1] = NA
EPU_belgium$MA = NA
EPU_belgium$ind = NA
EPU_belgium$MA[-1:-29] = RcppRoll::roll_mean(EPU_belgium$value, 30,na.rm = TRUE,)
EPU_belgium$ind[-1:-29] = RcppRoll::roll_sum(!is.na(EPU_belgium$value), 30,na.rm = TRUE)

EPU_belgium$value = EPU_belgium$MA
EPU_belgium = EPU_belgium[-1:-29,]
EPU_belgium$value[lubridate::wday(EPU_belgium$timestamp) == 1] = NA
EPU_belgium$value[EPU_belgium$ind < 20] = NA
EPU_belgium = EPU_belgium[-1,]
...
EPU_wal$value[lubridate::wday(EPU_wal$timestamp) == 1] = NA
EPU_wal$value[lubridate::year(EPU_wal$timestamp) == "2006"] = NA
EPU_wal$MA = NA
EPU_wal$ind = NA
EPU_wal$MA[-1:-29] = RcppRoll::roll_mean(EPU_wal$value, 30,na.rm = TRUE)
EPU_wal$ind[-1:-29] = RcppRoll::roll_sum(!is.na(EPU_wal$value), 30,na.rm = TRUE)
EPU_wal = EPU_wal[-1:-29,]
EPU_wal$value = EPU_wal$MA
EPU_wal$value[lubridate::wday(EPU_wal$timestamp) == 1] = NA
EPU_wal$value[EPU_wal$ind < 20] = NA
EPU_wal = EPU_wal[-1,]
