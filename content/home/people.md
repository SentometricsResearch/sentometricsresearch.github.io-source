...
Sentometrics is run by a small team across HEC Montréal, Université de Sherbrooke and Vrije
Universiteit Brussel — and it is also a training programme. Since 2016 the field has produced
doctoral theses, master's theses and open-source packages across five universities in three
countries. This is the lineage.
...
- **Olivier Delmarcelle** — Ghent University, 2020–, with Kris Boudt. Author of the **sentopics** R
  package.
- **Céleste Hardy** — HEC Liège, 2022–, with Marie Lambert. Retail fund flows and social concern.
