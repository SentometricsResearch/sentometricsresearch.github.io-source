...
Indices[!complete.cases(Indices),-1] = NA
export = Indices
export[,8] = ""
...
hc <- highchart(type = "stock") %>% 
  hc_add_series(data = Indices, hcaes(x = date,y = epu_belgium_MA),name = "epu-belgium", id = "epu_belgium_MA", type = "line",
    ...
    hc_add_series(data = Indices, hcaes(x = date,epu_flanders_MA),name = "epu-flanders", id = "epu_belgium_MA", type = "line",
                  tooltip = list(useHTML = TRUE, headerFormat= '', pointFormat = "<b>{series.name}</b><br> Date {point.date} <br/>  Daily Value = {point.epu_flanders_FL} <br/> 30-MA = {point.epu_flanders_MA}"))  %>% 
