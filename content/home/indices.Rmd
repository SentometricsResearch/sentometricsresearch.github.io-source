...
auth_drop = load("../../vault/credential.rds")
...
drop_upload('Indices.csv',path = "SentometricsWebsite Data/files",dtoken = token)
```
...
[Download file](https://www.dropbox.com/s/023opcj7hjeu2tk/Indices.csv?dl=1)
